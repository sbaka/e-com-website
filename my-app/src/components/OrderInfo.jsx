        ...
        return(
            <div className={styles.orderContainer}>
                ...
                <div className={styles.bottomPolicy}>
                    <p>
                        By clicking "Checkout" I acknowledge I have read and accepted the Terms 
                        and Conditions including the Privacy Notice and Cookies. 
                        I also have read and accepted Code Activated Shop's T/C & Refund Policy
                    </p>
                </div>
            </div>
        );    
