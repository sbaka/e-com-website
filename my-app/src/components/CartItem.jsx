      ...
      <div className={styles.bagItemContainer} >
        <div className={styles.bagItem}>
          <div className={styles.leftSideBag} >
            <img className={styles.bagItemImg} src="https://cdn.shopify.com/s/files/1/0605/1338/6692/products/E22CHECL0029_BLF3_hd-mface_533x.jpg?v=1646930100">
            </img>
          ...
          <div>
            <FontAwesomeIcon icon={faCircleXmark} className={styles.bagItemDelete} fontSize={30} />
          </div>
