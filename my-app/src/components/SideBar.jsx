      ...
      <div className={styles.sideContainer}>
        ...
        <ul>
          ...
          <li>
            ...
            <label className={styles.label} htmlFor="tshirt">
              T-shirt
            </label>
          </li>
          <li>
            <input type="checkbox" name="Chemises" className={styles.sideElt} />
            <label className={styles.label} htmlFor="Chemises">
              Chemises
            </label>
          </li>
          <li>
            <input type="checkbox" name="Shorts" className={styles.sideElt} />
            <label className={styles.label} htmlFor="Shorts">
              Shorts
            </label>
          </li>
          <li>
            <input
              type="checkbox"
              name="Pantalons"
              className={styles.sideElt}
            />
            <label className={styles.label} htmlFor="Pantalons">
              Pantalons
            </label>
          </li>
        </ul>
